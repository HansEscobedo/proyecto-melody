                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{route('concert.order.pay',['id' => $concert->id])}}" method="POST">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <p class="text-xl">{{ $concert->ticket_price }}</p>
                        </div>
                        ...
                        <div class="flex items-center justify-center">
                            ...
                            <p id="total" class="text-2xl text-center font-semibold">{{ $concert->ticket_price }}</p>
                        </div>
                        ...
                        <button id="boton" type="submit"
                            class="text-white bg-blue-600 hover:bg-blue-custom-1000 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Finalizar compra
                        </button>
